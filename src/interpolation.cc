...
kx::vec2 kx::barycentric_coordinates (const vec2& p0, const vec2& p1, const vec2& p2, const vec2& p)
{
    vec2 v1 = p1-p0;
    vec2 v2 = p2-p0;
    R d = det(v1,v2);
...
vec3 kx::barycentric_coordinates (const vec2& p0, const vec2& p1, const vec2& p2, const vec2& p3, const vec2& p)
{
    bool first_triangle = contains(p0, p1, p2, p);
    vec2 st = first_triangle ? barycentric_coordinates(p0, p1, p2, p) : barycentric_coordinates(p0, p2, p3, p);
