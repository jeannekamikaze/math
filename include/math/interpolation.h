...
inline vec3 interpolate (const vec3& p0, const vec3& p1, const vec3& p2, const vec2& st) {
...
inline vec3 interpolate (const vec3& p0, const vec3& p1, const vec3& p2, const vec3& p3, const vec3& stu) {
    if (stu.z > 0)
...
/// Return the barycentric coordinates of the point with respect to the triangle.
vec2 barycentric_coordinates (const Triangle2&, const vec2&);

/// Return the barycentric coordinates of the point with respect to the triangle.
vec2 barycentric_coordinates (const vec2& p0, const vec2& p1, const vec2& p2, const vec2&);
...
/// s = u>0: parameter along p0p1 edge, u<0: parameter along p0p2 edge.
/// t = u>0: parameter along p0p2 edge, u<0: parameter along p0p3 edge.
vec3 barycentric_coordinates (const vec2& p0, const vec2& p1, const vec2& p2, const vec2& p3, const vec2&);
