...
///
/// eps is used in deciding whether intersection exists. Set this to a relatively
/// high value if we want to err on the side of detecting intersections, or to a
/// relatively low value if we want to err on the side of skipping triangles.
///
...
/// Intersect a ray and a triangle.
KX_MATH_API bool intersect (const Ray3&, const vec3&, const vec3&, const vec3&, R& t, R eps, R tau);
...
/// Return true if the triangle contains the point, false otherwise.
KX_MATH_API bool contains (const vec2& p0, const vec2& p1, const vec2& p2, const vec2& p);

/// Return true if the quad contains the point, false otherwise.
KX_MATH_API bool contains (const Quad2&, const vec2&);

/// Return true if the quad contains the point, false otherwise.
KX_MATH_API bool contains (const vec2& p0, const vec2& p1, const vec2& p2, const vec2& p3, const vec2& p);
